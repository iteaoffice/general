...
$config = [
    'controllers'        => [
        'factories' => [
            ...
            Controller\LanguageController::class      => ConfigAbstractFactory::class,
            Controller\CountryController::class       => ConfigAbstractFactory::class,
            Controller\Country\VideoController::class => ConfigAbstractFactory::class,
    ...
    'view_helpers'       => [
        'aliases'    => [
            ...
            'challengeIdeaPosterImage' => View\Helper\Challenge\Idea\Poster\Image::class,
            'challengeIdeaPosterIcon'  => View\Helper\Challenge\Idea\Poster\Icon::class,
            ...
            'countryVideoLink'         => View\Helper\Country\VideoLink::class,
            'languageLink'             => View\Helper\LanguageLink::class,
        ...
        'factories'  => [
            ...
            View\Helper\Challenge\Idea\Poster\Image::class => View\Factory\ImageHelperFactory::class,
            View\Helper\Challenge\Idea\Poster\Icon::class  => View\Factory\ImageHelperFactory::class,
            ...
            View\Helper\Country\VideoLink::class           => View\Factory\LinkHelperFactory::class,
            ...
            View\Helper\LanguageLink::class                => View\Factory\LinkHelperFactory::class,
    ...
    'service_manager'    => [
        'factories'  => [
            ...
            InputFilter\LanguageFilter::class              => Factory\InputFilterFactory::class,
            ...
            Navigation\Invokable\Country\VideoLabel::class => NavigationInvokableFactory::class,
            Navigation\Invokable\LanguageLabel::class      => NavigationInvokableFactory::class,
