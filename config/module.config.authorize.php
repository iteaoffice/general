    ...
    'bjyauthorize' => [
        ...
        'guards' => [
            ...
            Route::class => [
                ...
                ['route' => 'zfcadmin/language/list', 'roles' => ['office'],],
                ['route' => 'zfcadmin/language/new', 'roles' => ['office'],],
                ['route' => 'zfcadmin/language/edit', 'roles' => ['office'],],
                ['route' => 'zfcadmin/language/view', 'roles' => ['office'],],
                ...
                ['route' => 'zfcadmin/country/video/view', 'roles' => ['office'],],
                ['route' => 'zfcadmin/country/video/edit', 'roles' => ['office'],],
                ['route' => 'zfcadmin/country/video/new', 'roles' => ['office'],],
